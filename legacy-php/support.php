...
<head>
    ...
    <title>Support - Smart विद्यालय</title>
    <!-- Premium Fonts -->
...
<body>
    ...
    <header class="section-padding"
        ...
        <div style="position: relative; z-index: 2;" data-aos="fade-up">
            <h1 style="font-size: 3.5rem; font-weight: 800; margin-bottom: 1.5rem;">We're Here to <br> <span
                    class="highlight"
                    style="background: linear-gradient(to right, #6366f1, #ec4899); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Help</span>
            </h1>
            <p style="font-size: 1.25rem; color: #94a3b8; max-width: 800px; margin: 0 auto; line-height: 1.8;">
                Need assistance? Our dedicated support team is ready to answer your questions.
            </p>
        </div>
    </header>
    ...
    <section class="section-padding" style="background: #f8fafc;">
        <div style="max-width: 1200px; margin: 0 auto; display: grid; grid-template-columns: 1fr 1fr; gap: 4rem;">
            ...
            <!-- Contact Options -->
            <div>
                <h2 style="font-size: 2rem; font-weight: 700; color: #1e293b; margin-bottom: 2rem;">Get in Touch</h2>

                <div class="glass-card-light" data-aos="fade-right"
                    style="min-height: auto; padding: 2rem; margin-bottom: 1.5rem;">
                    <div style="display: flex; align-items: start; gap: 1.5rem;">
                        <div
                            style="background: #e0e7ff; color: #4f46e5; width: 50px; height: 50px; border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 1.5rem;">
                            <i class="fas fa-envelope"></i>
                        </div>
                        <div>
                            <h3 style="font-size: 1.2rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">
                                Email Support</h3>
                            <p style="color: #64748b; margin-bottom: 0.5rem;">Our team usually responds within 24 hours.
                            </p>
                            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=smartvidhyalaya9861@gmail.com"
                                target="_blank"
                                style="color: #4f46e5; font-weight: 600; text-decoration: none;">smartvidhyalaya9861@gmail.com
                                &rarr;</a>
                        </div>
                    </div>
                </div>

                <div class="glass-card-light" data-aos="fade-right" data-aos-delay="100"
                    style="min-height: auto; padding: 2rem; margin-bottom: 1.5rem;">
                    <div style="display: flex; align-items: start; gap: 1.5rem;">
                        <div
                            style="background: #dcfce7; color: #16a34a; width: 50px; height: 50px; border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 1.5rem;">
                            <i class="fas fa-phone"></i>
                        </div>
                        <div>
                            <h3 style="font-size: 1.2rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">
                                Phone Support</h3>
                            <p style="color: #64748b; margin-bottom: 0.5rem;">Mon-Fri from 9am to 5pm.</p>
                            <a href="tel:+9779861079061"
                                style="color: #4f46e5; font-weight: 600; text-decoration: none;">+977-9861079061
                                &rarr;</a>
                        </div>
                    </div>
                </div>

                <div class="glass-card-light" data-aos="fade-right" data-aos-delay="200"
                    style="min-height: auto; padding: 2rem;">
                    <div style="display: flex; align-items: start; gap: 1.5rem;">
                        <div
                            style="background: #fce7f3; color: #db2777; width: 50px; height: 50px; border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 1.5rem;">
                            <i class="fas fa-map-marker-alt"></i>
                        </div>
                        <div>
                            <h3 style="font-size: 1.2rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">
                                Visit Office</h3>
                            <p style="color: #64748b; margin-bottom: 0.5rem;">Bharatpur, Nepal</p>
                            <a href="https://www.google.com/maps?q=27.681912,84.442490" target="_blank"
                                style="color: #4f46e5; font-weight: 600; text-decoration: none;">View on Map &rarr;</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- FAQ -->
            <div>
                <h2 style="font-size: 2rem; font-weight: 700; color: #1e293b; margin-bottom: 2rem;">Frequently Asked
                    Questions</h2>

                <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                    <div class="glass-card-light" data-aos="fade-left" style="min-height: auto; padding: 2rem;">
                        <h3 style="font-size: 1.2rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">How do I
                            get started?</h3>
                        <p style="color: #64748b;">Simply click on the "Get Started" button, choose your preferred plan,
                            and register your school. You can start managing your data immediately.</p>
                    </div>

                    <div class="glass-card-light" data-aos="fade-left" data-aos-delay="100"
                        style="min-height: auto; padding: 2rem;">
                        <h3 style="font-size: 1.2rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">Is my
                            data secure?</h3>
                        <p style="color: #64748b;">Yes, we use industry-standard encryption and secure servers to ensure
                            your school's data is safe and protected at all times.</p>
                    </div>

                    <div class="glass-card-light" data-aos="fade-left" data-aos-delay="200"
                        style="min-height: auto; padding: 2rem;">
                        <h3 style="font-size: 1.2rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">Can I
                            upgrade my plan later?</h3>
                        <p style="color: #64748b;">Absolutely! You can upgrade your subscription plan at any time from
                            your dashboard billing settings.</p>
                    </div>
                </div>
            </div>
